...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
#endif
    /* Default Layer: Ergo Switch - dedicated layer switch key
     * ,-----------------------------------------------------------.
     ...
     * |-----------------------------------------------------------|
     * | fn3 | Alt| Ctrl|    fn1    |     spc     | Gui | Alt| fn3 |
     * `-----------------------------------------------------------'
     */
    [0] = KEYMAP_LAYOUT_1(
        ...
        MO_FN3 , KC_LALT, KC_LCTL,          MO_FN1 ,                   KC_SPC ,          KC_RGUI, KC_RALT, MO_FN3 ),

    // Layer: Ergo Enter - big enter key
    [1] = KEYMAP_LAYOUT_1(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        MO_FN1 , _______, _______, _______, _______, _______, _______, _______, _______, _______,          MO_FN1 , \
    ...
    [2] = KEYMAP_LAYOUT_1(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        MO_FN1 , _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_ENT , \
    ...
    // Layer: Octopus - dual space with layer modifier
    [3] = KEYMAP_LAYOUT_1(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, \
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
